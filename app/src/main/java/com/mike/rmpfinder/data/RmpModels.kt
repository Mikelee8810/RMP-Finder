...
data class RmpRestaurant(
    ...
    val cuisineCategories: List<String> get() {
        ...
        add("Mexican", "mexican", "taco", "tamale", "burrito", "qdoba", "bites on valentine", "fatima's grill")
        add("Mediterranean & Halal", "gyro", "shawarma", "mediterranean", "halal", "fatima's grill")
